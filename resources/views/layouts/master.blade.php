...
<!-- Content Wrapper. Contains page content -->
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2016 <a href="#">Company</a>.</strong> All rights reserved. | Repost by <a href='https://fadhilahmad/' title='fadhilahmad' target='_blank'>fadhilahmad</a>
