...
<head>
    ...
    <title>VapeStore StockManagement | Login </title>
...
<div class="login-box">
    <div class="login-logo">
        <h1><b>VapeStore Stock</b> Management</h1>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">Sign in to start your session</p>
<br><center><p>Repost by <a href='https://instagram.com/fadhil_ahmad_h/' title='fadhilahmad' target='_blank'>fadhilahmad</a></p></center>
